const AddIncomeModal = () => {
    ...
    bloco.innerHTML = `
        <div class="modal__dialog">
            <div class="modal__header">
                <h2 class="modal__title">Nova Receita</h2>
            ...
            <div class="modal__body">
                <form class="modal__form">
                    ...
                    <div class="modal__field modal__field--custom">
                        ...
                        <button class="modal__button  modal__button--custom" type="button" id="button-paid">
                            <div class="modal__button-image">                             
                                <img 
                                    src="../image/paid.png" 
                                    alt="Botão Pago"
                            ...
                            <span class="modal__button-text">Pago</span>
                        </button>
                    </div>
                </form>
            </div>
    ...
    bloco.querySelector('#button-paid').addEventListener('click', () => {
        const buttonPaid = bloco.querySelector('#button-paid');
        const background = buttonPaid.querySelector('.modal__button-image');
        const image = buttonPaid.querySelector('#image-paid');
        image.src = image.src.includes('paid.png') ? '../image/paid_checked.png' : '../image/paid.png';
        background.classList.toggle('checked');
